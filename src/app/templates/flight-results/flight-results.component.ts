    ...
    this.MockFlightJSONService.getMockData().subscribe(
     res => {
      ...
      // One Way - Multiple Flights 
        ...
        // Connecting flight Model - One Way
      ...
      // Two Way - Multiple Flights
        ...
        // Connecting flight Model - Two Way
